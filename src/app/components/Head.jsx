...
const Head = () => {
  return (
    ...
    <Navbar/>
    <h1 className='text-white text-6xl   max-w-[900px] mx-auto leading-[5rem] tracking-wide text-center font-semibold mt-20'>Perfect for  Home applainces <span className='px-6 border-[1px] border-zinc-800 rounded-full pb-2 text-[#E84C61] text-5xl'>Repair</span> <span className='text-[#F8B81F]'>&</span>  <span className='px-5 border-[1px] border-zinc-800 rounded-full pb-2 text-[#32B879] text-5xl'>Service</span> </h1>
