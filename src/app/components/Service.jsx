...
const Service = () => {
  return (
    <div className='mt-40 bg-white relative w-full  z-10 py-10'>
        ...
        <p className='text-center text-5xl font-bold max-w-[800px] mx-auto relative'>Pre-Made Creative Online Course
